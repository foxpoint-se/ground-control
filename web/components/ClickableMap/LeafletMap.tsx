...
const LeafletMap = ({
  ...
  return (
    ...
    >
      ...
      <RotatableMarker
        position={[arrowLineMarker.lat, arrowLineMarker.lon]}
        icon={icons[arrowLineMarker.icon]}
        rotationAngle={arrowLineMarker.rotationAngle}
        zIndexOffset={arrowLineMarker.zIndexOffset}
      />
    </MapContainer>
  )
}
